...
function [f, gen_sol, all_evals, pop_log, pool_log] = MOMSA(dim,M,lb,ub,SearchAgents_no,Max_iter,ishow,trial)
fobj = @runP2P;
...
outFile = strcat('D:\Jacky\Data Output\Battery ROI\momsa_full_log (subs v3 unrank unlimit)', num2str(trial), '.xlsx');
