type = 'unlimit subsc v4 1'; % 'limit' or 'unlimit'

filename = strcat("D:\Jacky\Data Output\Battery ROI\MOMSA unrank ", type, ".xlsx");

[POS, ~, ~] = xlsread(filename, 'Sheet1');
[Fitness, ~, ~] = xlsread(filename, 'Sheet2');

[top5_loc, ranking, score] = R_method(Fitness,[1 2 3]);
...
filename_test = strcat("D:\Jacky\Data Output\Battery ROI\MOMSA ranked ", type, ".xlsx");
