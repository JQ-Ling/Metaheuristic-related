...
function [f, gen_sol, PF_log] = MOMSA(dim,M,lb,ub,SearchAgents_no,Max_iter,ishow)
fobj=@runP2P;
...
%% Select npop solutions among a combined population of 2*npop solutions  
   ...
   PF_log{t} = new_Sol(:, dim+1:dim+M);   % raw archive objectives this iter
end
f=new_Sol;
