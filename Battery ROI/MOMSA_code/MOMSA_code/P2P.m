function [fit, TNB_revenue_CES, cost, EFCs] = P2P(L)
    global errtol busnum basemva basevoltage busga linedat

    input = L./0.57; % convert to priority, prioritize lower price to let user use it first
    nbCES = 2;
