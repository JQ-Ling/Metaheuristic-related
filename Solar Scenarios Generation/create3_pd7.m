function pd1 = create3_pd7(actualpu7)
...
% This function was automatically generated on 08-Apr-2022 15:43:28
...
%     pd1 = ProbDistUnivParam('weibull',[ 0.6819474688834, 7.337469998918])
pd1 = fitdist(actualpu7, 'weibull');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 20';
