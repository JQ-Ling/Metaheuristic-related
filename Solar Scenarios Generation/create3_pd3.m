function pd1 = create3_pd3(actualpu3)
...
% This function was automatically generated on 08-Apr-2022 15:38:54
...
%     pd1 = ProbDistUnivParam('burr',[ 0.2767384975173, 5.258488712817, 1.704701813125])
pd1 = fitdist(actualpu3, 'burr');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 16';
