function pd1 = create3_pd4(actualpu4)
...
% This function was automatically generated on 08-Apr-2022 15:39:56
...
%     pd1 = ProbDistUnivParam('burr',[ 0.3963696136705, 6.013487338896, 1.838274620357])
pd1 = fitdist(actualpu4, 'burr');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 17';
