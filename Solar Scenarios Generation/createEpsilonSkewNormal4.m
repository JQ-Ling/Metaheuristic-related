function pd1 = createEpsilonSkewNormal4(actualpu4)
...
% This function was automatically generated on 06-Apr-2022 19:51:33
...
%     pd1 = ProbDistUnivParam('EpsilonSkewNormal',[ 0.3604534175948, 0.06741686369843, 0.1359450539895])
pd1 = fitdist(actualpu4, 'EpsilonSkewNormal');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 11';
