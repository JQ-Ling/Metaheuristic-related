function pd1 = createExtremeValue5(actualpu5)
...
% This function was automatically generated on 06-Apr-2022 19:52:24
...
%     pd1 = ProbDistUnivParam('extreme value',[ 0.4725338570301, 0.05826506997457])
pd1 = fitdist(actualpu5, 'extreme value');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 12';
