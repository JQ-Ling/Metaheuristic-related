function pd1 = create3_pd5(actualpu5)
...
% This function was automatically generated on 08-Apr-2022 15:40:51
...
%     pd1 = ProbDistUnivParam('EpsilonSkewNormal',[ 0.4454118601668, 0.09909071759391, -0.05053842190291])
pd1 = fitdist(actualpu5, 'EpsilonSkewNormal');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 18';
