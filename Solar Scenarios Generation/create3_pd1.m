function pd1 = create3_pd1(actualpu1)
...
% This function was automatically generated on 08-Apr-2022 15:35:01
...
%     pd1 = ProbDistUnivParam('exponential',[ 0.01012828780539])
pd1 = fitdist(actualpu1, 'exponential');
YPlot = pdf(pd1,XGrid);
