function pd1 = create3_pd2(actualpu2)
...
% This function was automatically generated on 08-Apr-2022 15:37:44
...
%     pd1 = ProbDistUnivParam('generalized extreme value',[ -0.05360099699496, 0.04867493712285, 0.1222432399189])
pd1 = fitdist(actualpu2, 'generalized extreme value');
YPlot = pdf(pd1,XGrid);
hLine = plot(XGrid,YPlot,'Color',[1 0 0],...
    'LineStyle','-', 'LineWidth',2,...
    'Marker','none', 'MarkerSize',6);
LegHandles(end+1) = hLine;
LegText{end+1} = 'fit 15';
