...
D = 33; % Number of decision variables
...
for i = 1:1
    ...
    [Pareto, gen_sol, all_evals, pop_log, pool_log] = MOMSA(D, M, LB, UB, N, GEN, ishow, i);
    ...
    filename_test = strcat("D:\Jacky\Data Output\Battery ROI\MOMSA unrank unlimit subsc v3 ", num2str(i), ".xlsx");
